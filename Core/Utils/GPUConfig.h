...
class GPUConfig {
 ...
 private:
  GPUConfig()
    ...
    icpStepMap["Quadro P4000"] = std::pair<int, int>(128, 96);
    rgbStepMap["Quadro P4000"] = std::pair<int, int>(112, 96);
    rgbResMap["Quadro P4000"] = std::pair<int, int>(256, 416);
    so3StepMap["Quadro P4000"] = std::pair<int, int>(128, 64);
